...
async function handleInit() {
  ...
  if (!userStore.value.isLogin) return;
...
async function handleConversationStart(_sentence: string) {
  await $aigc.startConversation(_sentence, true);

  if (sentence.value === _sentence) sentence.value = "";
}
